export function getTodayChain() {
  ...
  const targets = {
    ...
    '2025-06-25': ['2025_Stanley_Cup_Finals', 'River', 'Headache'],
    '2025-06-26': ['Louisiana_Purchase', 'Salt', 'Imagination'],
    '2025-06-27': ['Dancing_mania', 'Fish', 'Sprite_(drink)'],
    '2025-06-28': ['Response_to_sneezing', 'Universal_Studios_Florida', 'Water'],
    '2025-06-29': ['Kentucky_Bend', 'Antarctica', 'Guitar'],
    '2025-06-30': ['Christina\'s_World', 'T-shirt', 'Blood'],
    '2025-07-01': ['The_X-Files', 'WWE', 'Saturn'],
    '2025-07-02': ['Diamond_Life', 'School', 'Wallet'],
    '2025-07-03': ['Basketball', 'Milwaukee', 'Arcade_cabinet', ],
    '2025-07-04': ['Born_on_the_Fourth_of_July_(film)', 'Fireworks', 'Flag'],
    '2025-07-05': ['', '', ''],
    '2025-07-06': ['', '', ''],
    '2025-07-07': ['', '', ''],
    '2025-07-08': ['', '', ''],
