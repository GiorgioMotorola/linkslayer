export const shopItems = [
  ...
  },
  {
    ...
    effect: "inventoryItem",
    details: "fishingRod",
    description: "A sturdy rod and line. Find a body of water on any article and fish for your supper. Permanent.",
    haikuOne: "Line cast to still depths",
    haikuTwo: "Patience earns the silver flash",
    haikuThree: "Supper from the lake.",
  },
  {
    id: "aluminum_rod",
    name: "Aluminum Fishing Rod",
    cost: 72,
    effect: "inventoryItem",
    details: "aluminumRod",
    description: "An upgrade from the basic rod. Better odds at rare catches, shorter wait. Replaces your current rod.",
    haikuOne: "Silver tip cuts deep",
    haikuTwo: "The line seeks rarer currents",
    haikuThree: "More patience, more prize.",
  },
  {
    id: "carbon_rod",
    ...
    effect: "inventoryItem",
    details: "carbonRod",
    description: "Master-tier rod. Best loot table, fastest bites. Replaces your current rod.",
    haikuOne: "Woven carbon, dark",
    haikuTwo: "Even the deep yields its prize",
    haikuThree: "The water knows you.",
  },
  {
